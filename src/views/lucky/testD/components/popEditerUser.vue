  ...
  >
    <el-form ref="formRef" v-loading="submitLoading" label-width="auto" :model="formData" :rules="rules">
      <el-row>
        <el-col :span="12">
          <el-form-item :label="$t('systemManager.userManager.accountName')" prop="username">
            <el-input
              ...
              maxlength="20"
              show-word-limit
              :placeholder="$t('systemManager.userManager.accountNameTip')"
              clearable
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="$t('page.mobilePhone')" prop="mobileNo">
            <el-input
        ...
        <el-col :span="24">
          <el-form-item :label="$t('page.email')" prop="emailNo">
            <el-input
              v-model="formData.emailNo"
              :placeholder="$t('page.dialog.input.errorTips.email')"
              clearable
              maxlength="200"
              show-word-limit
            />
        ...
        <el-col :span="12">
          <el-form-item :label="$t('page.role')" prop="roleId" class="mb-0">
            <el-select v-model="formData.roleId" :placeholder="$t('page.dialog.select.errorTips.userRole')" clearable filterable>
        ...
        <el-col :span="12">
          <el-form-item :label="$t('systemManager.userManager.username')" prop="nickname">
            <el-input
              ...
              :placeholder="$t('systemManager.userManager.inputUserName')"
              maxlength="20"
              show-word-limit
              clearable
            />
...
// import { addUserInfo, updateUserInfo } from '@/api/userManager'
...
const rules = {
  ...
  nickname: [
    {
      required: true,
      message: i18n.global.t('systemManager.userManager.usernameTip1'),
      trigger: ['change', 'blur'],
    },
  ],
