        ...
        function l(t, e, r, n) {
          if (t.data && t.data.shuffle) {
            ...
            for (
              ...
              for (var k = 0; k < h; k++) b.push({ startX: Math.floor(k * g), startY: Math.floor(C * A) }), w.push({ startX: Math.round(k * m), startY: Math.round(C * y) })
            for (
              var D = [],
                E = function () {
                  var t = v[B],
              ...
              },
              {
                ...
                value: function () {
                  var t = '',
                    ...
                    a = 'images/logo.png',
                    i = this.styleConfig
                  i && ((t = i.btnUrl), (e = i.bgUrl), (n = i.moveTrackMaskBgColor), (r = i.moveTrackMaskBorderColor), i.logoUrl && (a = this.styleConfig.logoUrl)),
            ...
            (r = [
              ...
              },
              {
                ...
                value: function () {
                  var t = this.currentCaptchaData.moveX
                  this.el.find('#tianai-captcha-slider-move-btn').css('transform', 'translate(' + t + 'px, 0px)'),
                    this.el.find('#tianai-captcha-slider-move-img').css('transform', 'rotate(' + t / (this.currentCaptchaData.end / 360) + 'deg)'),
                    this.el.find('#tianai-captcha-slider-move-track-mask').css('width', t + 'px')
                },
              },
              {
            ...
            (r = [
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  n.css('height', i), (t.currentCaptchaData = g(r.width(), r.height(), n.width(), n.height(), 242)), (t.currentCaptchaData.currentCaptchaId = e.id)
                },
              },
            ]) && M(e.prototype, r),
            Object.defineProperty(e, 'prototype', { writable: !1 }),
                    ...
                    return (
                      ...
                      this.el.find('#bg-img-click-mask').click(function (t) {
                        ...
                        1 === n.currentCaptchaData.clickCount &&
                          (window.addEventListener('mousemove', h), (n.currentCaptchaData.startX = t.offsetX), (n.currentCaptchaData.startY = t.offsetY)),
                          e.push({ x: Math.round(t.offsetX), y: Math.round(t.offsetY), type: 'click', t: new Date().getTime() - r.getTime() })
                        var a = t.offsetX - 10,
                          i = t.offsetY - 10
                        n.el.find('#bg-img-click-mask').append("<span class='click-span' style='left:" + a + 'px;top: ' + i + "px'>" + n.currentCaptchaData.clickCount + '</span>'),
                          4 === n.currentCaptchaData.clickCount &&
                            ((n.currentCaptchaData.stopTime = new Date()), window.removeEventListener('mousemove', h), n.endCallback(n.currentCaptchaData, n))
                      }),
                      r && r(this),
                      this
                    )
            ...
            return (
              ...
              (r = [
                ...
                },
                {
                  key: 'validSuccess',
                  value: function (t, e, r) {
                    console.log('验证码校验成功， 请重写  [config.validSuccess] 方法， 用于自定义逻辑处理'), (window.currentCaptchaRes = t), r.destroyWindow()
                  },
                },
                {
                  key: 'validFail',
            ...
            !(function (t, e) {
              ...
              (this.style = (function (t) {
                return (
                  ...
                  t.moveTrackMaskBgColor || t.moveTrackMaskBorderColor || ((t.moveTrackMaskBgColor = '#89d2ff'), (t.moveTrackMaskBorderColor = '#0298f8')),
                  t
                )
              })(r))
          }
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t && this.config.$bindEl.find('#tianai-captcha-bg-img').css('background-image', 'url(' + t + ')'),
                    e && ('' !== e ? this.config.$bindEl.find('#tianai-captcha-logo').attr('src', e) : this.config.$bindEl.find('#tianai-captcha-logo').css('display', 'none'))
                },
              },
              {
                key: 'destroyWindow',
            ...
            (m = {
              ...
              accept: function (t, e, r) {
                if (void 0 === t) m._selfAccepted = !0
                  ...
                  for (var n = 0; n < t.length; n++) (m._acceptedDependencies[t[n]] = e || function () {}), (m._acceptedErrorHandlers[t[n]] = r)
                        ...
                        (i.onerror = i.onload =
                          (r) => {
                            if (((i.onerror = i.onload = null), 'load' === r.type)) n()
                              ...
                              ;(s.code = 'CSS_CHUNK_LOAD_FAILED'), (s.type = o), (s.request = c), i.parentNode && i.parentNode.removeChild(i), a(s)
                            }
                          }),
                        (i.href = e),
          ...
          new Promise((t, r) => {
            ...
            a.l(n, (t) => {
              if (c[e]) {
                ...
                ;(i.message = 'Loading hot update chunk ' + e + ' failed.\n(' + n + ': ' + a + ')'), (i.name = 'ChunkLoadError'), (i.type = n), (i.request = a), r(i)
              }
            })
          })
        )
      ...
      function u(t) {
            ...
            if (u && (!u.hot._selfAccepted || u.hot._selfInvalidated)) {
              ...
              for (var l = 0; l < u.parents.length; l++) {
                ...
                if (p) {
                  ...
                  ;-1 === e.indexOf(d) && (p.hot._acceptedDependencies[o] ? (r[d] || (r[d] = []), s(r[d], [o])) : (delete r[d], e.push(d), n.push({ chain: c.concat([d]), id: d })))
                }
              }
            }
          }
        ...
        for (var h in r)
          if (a.o(r, h)) {
            var f,
              ...
              m = !1,
              y = ''
            switch (((f = v ? c(h) : { type: 'disposed', moduleId: h }).chain && (y = '\nUpdate propagation: ' + f.chain.join(' -> ')), f.type)) {
              case 'self-declined':
                t.onDeclined && t.onDeclined(f), t.ignoreDeclined || (g = new Error('Aborted because of self decline: ' + f.moduleId + y))
                break
              case 'declined':
                t.onDeclined && t.onDeclined(f), t.ignoreDeclined || (g = new Error('Aborted because of declined dependency: ' + f.moduleId + ' in ' + f.parentId + y))
                break
              case 'unaccepted':
            ...
            if (g) return { error: g }
            if (A)
              for (h in ((d[h] = v), s(l, f.outdatedModules), f.outdatedDependencies)) a.o(f.outdatedDependencies, h) && (u[h] || (u[h] = []), s(u[h], f.outdatedDependencies[h]))
        ...
        return {
          dispose: function () {
            ...
            for (var h in u) if (a.o(u, h) && (c = a.c[h])) for (b = u[h], C = 0; C < b.length; C++) (e = b[C]), (t = c.children.indexOf(e)) >= 0 && c.children.splice(t, 1)
          },
          apply: function (e) {
                    ...
                    try {
                      ...
                      if ('function' == typeof p[m])
                        try {
                          ...
                          t.onErrored && t.onErrored({ type: 'accept-error-handler-errored', moduleId: o, dependencyId: h[m], error: n, originalError: r }),
                            t.ignoreErrored || (e(n), e(r))
                        }
                      else t.onErrored && t.onErrored({ type: 'accept-errored', moduleId: o, dependencyId: h[m], error: r }), t.ignoreErrored || e(r)
                    }
                }
              }
              ...
              try {
                ...
                if ('function' == typeof C.errorHandler)
                  try {
                    ...
                    t.onErrored && t.onErrored({ type: 'self-accept-error-handler-errored', moduleId: k, error: n, originalError: r }), t.ignoreErrored || (e(n), e(r))
                  }
